...
Ollama installs as a menu bar application and starts automatically on login.
...
```
python3 scripts/run_ingestion.py
python3 scripts/run_ingestion.py --chunks-file data/datastore/chunks.json
python3 scripts/run_ingestion.py --reset
```

Step 3 - (Optional) Verify the store was populated correctly:

```
python3 scripts/verify_store.py
```
